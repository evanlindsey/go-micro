...
import (
	...
	"github.com/evanlindsey/go-micro/petstore/ent/migrate"
...
func (c *PetClient) UpdateOneID(id int64) *PetUpdateOne {
...
func (c *PetClient) DeleteOneID(id int64) *PetDeleteOne {
...
func (c *PetClient) Get(ctx context.Context, id int64) (*Pet, error) {
	return c.Query().Where(pet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PetClient) GetX(ctx context.Context, id int64) *Pet {
