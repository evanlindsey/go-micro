...
func (pq *PetQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *PetQuery) FirstIDX(ctx context.Context) int64 {
...
func (pq *PetQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *PetQuery) OnlyIDX(ctx context.Context) int64 {
...
func (pq *PetQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (pq *PetQuery) IDsX(ctx context.Context) []int64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PetQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(pet.Table, pet.Columns, sqlgraph.NewFieldSpec(pet.FieldID, field.TypeInt64))
	_spec.From = pq.sql
