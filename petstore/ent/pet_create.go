...
func (pc *PetCreate) SetTag(s string) *PetCreate {
	pc.mutation.SetTag(s)
	return pc
}

// SetNillableTag sets the "tag" field if the given value is not nil.
func (pc *PetCreate) SetNillableTag(s *string) *PetCreate {
	if s != nil {
		pc.SetTag(*s)
	}
	return pc
...
func (pc *PetCreate) SetID(i int64) *PetCreate {
	pc.mutation.SetID(i)
	return pc
}
...
func (pc *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(pet.Table, sqlgraph.NewFieldSpec(pet.FieldID, field.TypeInt64))
	)
