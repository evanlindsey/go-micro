...
func withPetID(id int64) petOption {
...
func (m *PetMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *PetMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *PetMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
...
func (m *PetMutation) SetTag(s string) {
	m.tag = &s
}

// Tag returns the value of the "tag" field in the mutation.
func (m *PetMutation) Tag() (r string, exists bool) {
	v := m.tag
	if v == nil {
		return
	}
...
// OldTag returns the old "tag" field's value of the Pet entity.
// If the Pet object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PetMutation) OldTag(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PetMutation) ClearTag() {
	m.tag = nil
	m.clearedFields[pet.FieldTag] = struct{}{}
}

// TagCleared returns if the "tag" field was cleared in this mutation.
func (m *PetMutation) TagCleared() bool {
	_, ok := m.clearedFields[pet.FieldTag]
	return ok
}

// ResetTag resets all changes to the "tag" field.
func (m *PetMutation) ResetTag() {
	m.tag = nil
	delete(m.clearedFields, pet.FieldTag)
}
...
func (m *PetMutation) Fields() []string {
	...
	if m.tag != nil {
		fields = append(fields, pet.FieldTag)
	}
	return fields
}
...
func (m *PetMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(pet.FieldTag) {
		fields = append(fields, pet.FieldTag)
	}
	return fields
}
